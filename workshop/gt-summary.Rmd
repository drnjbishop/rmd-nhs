...
-   This set contains data from `r nrow(trial)` patients who received one of two types of chemotherapy (Drug A or Drug B). The outcomes are tumor response and death.
...
> `r inline_text(tbl_m1, variable = age)` It is reasonable that you'll need to modify the text.
